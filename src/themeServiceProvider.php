<?php namespace Parsidev\LaravelTheme;

use Parsidev\LaravelTheme\Commands\createPackage;
use Parsidev\LaravelTheme\Commands\createTheme;
use Parsidev\LaravelTheme\Commands\installPackage;
use Parsidev\LaravelTheme\Commands\listThemes;
use Parsidev\LaravelTheme\Commands\refreshCache;
use Parsidev\LaravelTheme\Commands\removeTheme;
...
class themeServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('parsidev.themes', function () {
            return new Themes();
        });
        ...
        $this->app->singleton('view.finder', function ($app) {
            return new \Parsidev\LaravelTheme\themeViewFinder(
                $app['files'],
    ...
    public function boot()
    {
        ...
        $themes = $this->app->make('parsidev.themes');
        $themes->scanThemes();
